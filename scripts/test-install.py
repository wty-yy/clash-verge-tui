...
class InstallerTests(unittest.TestCase):
    ...
    def test_github_default(self):
        ...
        self.responses[repo + '/releases/latest'] = repo + '/releases/tag/v1.4.7'
        self.bundle(repo + '/releases/download/v1.4.7')
    ...
    def test_proxy_without_direct_discovery_for_both_architectures(self):
        for architecture in ['x86_64', 'aarch64']:
            with self.subTest(architecture=architecture):
                ...
                self.bundle('https://gh-proxy.com/https://github.com/wty-yy/clash-verge-tui/releases/download/v1.4.7', architecture)
    ...
    def test_explicit_version_skips_api(self):
        self.env['CLASH_VERGE_TUI_VERSION'] = 'v1.4.7'
        self.bundle('https://gh-proxy.com/https://github.com/wty-yy/clash-verge-tui/releases/download/v1.4.7')
        self.assert_installed(self.run_installer('--source', 'proxy'))
    ...
    def test_repository_override_and_trailing_git(self):
        ...
        self.responses['https://github.com/example/mirror/releases/latest'] = 'https://github.com/example/mirror/releases/tag/v1.4.7'
        self.bundle('https://github.com/example/mirror/releases/download/v1.4.7')
        self.assert_installed(self.run_installer())

    def test_asset_override_and_install_directory(self):
        self.env.update(CLASH_VERGE_TUI_VERSION='v1.4.7', CLASH_VERGE_TUI_ASSET_BASE_URL='https://example.com/assets',
    ...
    def test_invalid_release_tag_and_arguments(self):
        ...
        self.env['CLASH_VERGE_TUI_VERSION'] = 'v1.4.7/../../other'
    ...
    def test_missing_or_corrupt_assets_preserve_installation(self):
        self.env['CLASH_VERGE_TUI_VERSION'] = 'v1.4.7'
        base = 'https://gh-proxy.com/https://github.com/wty-yy/clash-verge-tui/releases/download/v1.4.7'
    ...
    def test_missing_geosite_preserves_installation(self):
        self.env['CLASH_VERGE_TUI_VERSION'] = 'v1.4.7'
        self.bundle('https://github.com/wty-yy/clash-verge-tui/releases/download/v1.4.7', include_geosite=False)
        installed = self.home / '.local/bin/clash-verge-tui'
        installed.parent.mkdir(parents=True)
        installed.write_text('original installation')
